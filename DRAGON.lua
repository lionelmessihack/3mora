...
if res ~= 200 then
print('\27[0;31mٴ≪┉ ┉ ┉ ┉ ┉ 𝑬𝑳𝑲 ┉  ┉ ┉ ┉ ┉≫ٴ\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \naٴ≪┉ ┉ ┉ ┉ ┉ 𝑬𝑳𝑲 ┉  ┉ ┉ ┉ ┉≫ٴ\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35mٴ≪┉ ┉ ┉ ┉ ┉ 𝑬𝑳𝑲 ┉  ┉ ┉ ┉ ┉≫ٴ ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
os.execute('lua ELKIMA.lua')
end
...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./ELKIMA.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("DRG", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S ELKIMA -X kill
screen -S ELKIMA ./ELKIMA
done
]])  
file:close() 
...
io.popen("cd File_Bot && wget https://github.com/SRC-ELKIMA/ELKIMA/SRC-ELKIMA/Files_ELKIMA/main/File_Bot/commands.lua") 
...
local ELKIMA_Msg = ''  
if msgs < 100 then 
ELKIMA_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
ELKIMA_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
ELKIMA_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
ELKIMA_Msg = 'متفاعل' 
elseif msgs < 1200 then 
ELKIMA_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
ELKIMA_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
ELKIMA_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
ELKIMA_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
ELKIMA_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
ELKIMA_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
ELKIMA_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
ELKIMA_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
ELKIMA_Msg = 'رب التفاعل'  
end 
return ELKIMA_Msg 
end
...
function plugin_ELKIMA(msg)
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
plugin = dofile("File_Bot/"..v)
if plugin.ELKIMA and msg then
pre_msg = plugin.ELKIMA(msg)
end
end
end
...
--------------------------------------------------------------------------------------------------------------
function SourceELKIMA(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,ELKIMA_Msg) 
return false  
end 
if text then    
...
os.execute('rm -rf ELKIMA.lua')
os.execute('wget https://github.com/SRC-ELKIMA/ELKIMA/SRC-ELKIMA/ELKIMA/main/ELKIMA.lua')
send(msg.chat_id_, msg.id_,' ℘︙ تم تحديث السورس \n ℘︙ لديك اخر اصدار لسورس القمه\n ℘︙ الاصدار » { v 1.5}')
dofile('ELKIMA.lua')  
end
if text == 'الاصدار ℘' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ℘︙ اصدار سورس القمه \n ℘︙ الاصدار »{ v 1.5}')
end
...
send(msg.chat_id_, msg.id_,'℘︙  عدد الكروبات الان » { '..#group..' }'..ELKIMAk..''..ELKIMA..'\n℘︙  الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
local ELKIMA1_Msg = database:get(bot_id.."ELKIMA1:Add:Filter:Rp2"..text..msg.chat_id_)   
if ELKIMA1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
--------------------------------------------------------------------------------------------------------------
if ELKIMA_Msg and not Special(msg) then  
local ELKIMA_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if ELKIMA_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
database:sadd(bot_id.."ELKIMA:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."ELKIMA:blocname"..msg.chat_id_)
...
if name_MRSOFI then 
names_MRSOFI = database:smembers(bot_id.."ELKIMA:blocname"..msg.chat_id_) or ""
...
database:set(bot_id.."ELKIMA:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."ELKIMA:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."ELKIMA:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."ELKIMA:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."ELKIMA:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function sofi_mrsofi_new(mrsofi1,mrsofi2)
if mrsofi2 and mrsofi2.first_name_ then 
if mrsofi2.first_name_:match("(.*)"..database:get(bot_id.."ELKIMA:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."ELKIMA:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local mrsofi_nnn = database:get(bot_id.."ELKIMA:nump"..msg.chat_id_) or 5
local mrsofi_nnn2 = database:get(bot_id.."ELKIMA:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(mrsofi_nnn2) == tonumber(mrsofi_nnn) or tonumber(mrsofi_nnn2) > tonumber(mrsofi_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."ELKIMA:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "℘︙ عزيزي >>["..mrsofi2.username_.."](https://t.me/"..(mrsofi2.username_ or "Messi_ElKBer")..")\n℘︙ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."ELKIMA:teh"..msg.chat_id_).."} بجانب اسمك\n℘︙ عدد المحاولات المتبقيه {"..(tonumber(mrsofi_nnn) - tonumber(mrsofi_nnn2)).."}")
end
end
end
end
...
local ELKIMAChengName = database:get(bot_id.."ELKIMA:Cheng:Name"..data.id_)
if not data.first_name_ then 
if ELKIMAChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..ELKIMAChengName..']')
database:del(bot_id.."ELKIMA:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if ELKIMAChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."ELKIMA:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local ELKIMAChengUserName = database:get(bot_id.."ELKIMA:Cheng:UserName"..data.id_)
if not data.username_ then 
if ELKIMAChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..ELKIMAChengUserName..']')
database:del(bot_id.."ELKIMA:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if ELKIMAChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."ELKIMA:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local ELKIMAChengPhoto = database:get(bot_id.."ELKIMA:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if ELKIMAChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."ELKIMA:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if ELKIMAChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."ELKIMA:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)  
...
℘ ⦑ SOURCE ELKIMA ⦒ 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
℘︙ [Source Channel](t.me/Messi_ElKBer)
℘︙ [Source Update ](t.me/Bedo11111)     
℘︙ [Source developer](t.me/Medoiuu)     
℘︙ [ELKIMA programmer](t.me/Ascorpion_1) 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
𓂅 . [TWS ELKIMA](t.me/Messi_ElKBerbot)     
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://github.com/SRC-ELKIMA/ELKIMA/SRC-ELKIMA/Files_ELKIMA/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://github.com/SRC-ELKIMA/ELKIMA/SRC-ELKIMA/Files_ELKIMA/main/File_Bot/"..file)
if res == 200 then
...
local UserName = (b.username_ or "SRC-ELKIMA")
...
function Function_ELKIMA(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_ELKIMA, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_ELKIMA, nil)
return false 
end
...
' }\n'..' ℘︙  الايدي بالصوره » { '..idph..
' }\n'..' ℘︙  الرفع » { '..setadd..
' }\n'..' ℘︙  الحظر » { '..banm..' }\n\nٴ≪┉ ┉ ┉ ┉ ┉ 𝑬𝑳𝑲 ┉  ┉ ┉ ┉ ┉≫ٴ\n ℘︙ قناة سورس القمه ↓\n [🖨┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 𝙳𝚁𝙰𝙶𝙾𝙽.](t.me/Messi_ElKBer) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
database:set(bot_id.."ELKIMA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."ELKIMA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ℘︙ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."ELKIMA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."ELKIMA1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."ELKIMA1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."ELKIMA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ℘︙ تم منع الكلمه مع التحذير")  
database:del(bot_id.."ELKIMA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."ELKIMA1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."ELKIMA1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."ELKIMA1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ℘︙ ارسل الكلمه الان")  
database:set(bot_id.."ELKIMA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."ELKIMA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."ELKIMA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."ELKIMA1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."ELKIMA1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."ELKIMA1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."ELKIMA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."ELKIMA1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."ELKIMA1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ℘︙ قائمة المنع \nٴ≪┉ ┉ ┉ ┉ ┉ 𝑬𝑳𝑲 ┉  ┉ ┉ ┉ ┉≫ٴ\n"
for k,v in pairs(list) do  
local ELKIMA_Msg = database:get(bot_id.."ELKIMA1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..ELKIMA_Msg.."}\n"    
end  
if #list == 0 then  
...
send(msg.chat_id_, msg.id_,'['..ELKIMA_Msg[math.random(#ELKIMA_Msg)]..']') 
return false
end
...
------------------------------------------------------------------------
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:ELKIMA:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\n ℘︙ ارسل الكلمه تريد اضافتها')
database:set(bot_id.."botss:ELKIMA:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."botss:ELKIMA:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."botss:ELKIMA:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:ELKIMA:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"℘︙ تم حذف الرد من ردود المتعدده")
database:del(bot_id..'botss:ELKIMA:Add:Rd:Sudo:Text'..text)
database:del(bot_id..'botss:ELKIMA:Add:Rd:Sudo:Text1'..text)
database:del(bot_id..'botss:ELKIMA:Add:Rd:Sudo:Text2'..text)
database:del(bot_id.."botss:ELKIMA:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."botss:ELKIMA:List:Rd:Sudo", text)
return false
end
end
...
local list = database:smembers(bot_id.."botss:ELKIMA:List:Rd:Sudo")
for k,v in pairs(list) do  
database:del(bot_id.."botss:ELKIMA:Add:Rd:Sudo:Text"..v) 
database:del(bot_id.."botss:ELKIMA:Add:Rd:Sudo:Text1"..v) 
database:del(bot_id.."botss:ELKIMA:Add:Rd:Sudo:Text2"..v)   
database:del(bot_id.."botss:ELKIMA:List:Rd:Sudo")
end
...
end --الكود حصري سورس القمه يعني لو بكتهن راح اعرفك انت الاخذتهن
...
database:set(bot_id.."botss:ELKIMA:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
...
database:set(bot_id.."botss:ELKIMA:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"℘︙ارسل الان الكلمه لحذفها ")
end
if text then  
local test = database:get(bot_id.."botss:ELKIMA:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:ELKIMA:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:set(bot_id.."botss:ELKIMA:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:ELKIMA:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:ELKIMA:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:ELKIMA:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd1" then
database:set(bot_id.."botss:ELKIMA:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:ELKIMA:Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:ELKIMA:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:ELKIMA:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd2" then
database:set(bot_id.."botss:ELKIMA:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:ELKIMA:Add:Rd:Sudo:Text2"..test, text)  
end  
send(msg.chat_id_, msg.id_,"℘︙تم حفظ الرد")
return false  
end  
...
if text then
local Text = database:get(bot_id.."botss:ELKIMA:Add:Rd:Sudo:Text"..text)   
local Text1 = database:get(bot_id.."botss:ELKIMA:Add:Rd:Sudo:Text1"..text)   
local Text2 = database:get(bot_id.."botss:ELKIMA:Add:Rd:Sudo:Text2"..text)   
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'القمه').." غادر" or text == 'بوت غادر' then  
...
-- vardump(data) 
ELKIMAdx(msg.chat_id_, msg.id_, ' ℘︙ ايدي المجموعة » ( '..msg.chat_id_..' )\n ℘︙ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ℘︙ عدد المحظورين » ( *'..data.kicked_count_..' )*\n ℘︙ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
{
{text = '𝐃𝐑𝐀𝐆𝐎𝐍 𝐂𝐇𝐀𝐍𝐍𝐄𝐋', url="t.me/Messi_ElKBer"},
},
}
local msg_id = msg.id_/2097152/0.5
...
send(msg.chat_id_, msg.id_, t..'ٴ≪┉ ┉ ┉ ┉ ┉ 𝑬𝑳𝑲 ┉  ┉ ┉ ┉ ┉≫ٴٴ\n℘︙ ➫ .[🖨┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 𝙳𝚁𝙰𝙶𝙾𝙽. ](t.me/Messi_ElKBer)➤ ')
end
...
ELKIMA = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(ELKIMA)
...
--------------------------------------------------------------------------------------------------------------
SourceELKIMA(data.message_,data)
plugin_ELKIMA(data.message_)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ then
...
------------------------------------------------------------------------
local ELKIMAAbot = database:get(bot_id.."ELKIMA1:Add:Filter:Rp2"..text..result.chat_id_)   
if ELKIMAAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ℘︙ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ℘︙ ["..ELKIMAAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local ELKIMA1_Msg = database:get(bot_id.."ELKIMA1:Add:Filter:Rp2"..text..result.chat_id_)   
if ELKIMA1_Msg then    
send(msg.chat_id_, msg.id_," ℘︙ "..ELKIMA1_Msg)
