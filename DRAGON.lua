...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/Snipertito/evall/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1885313077,968613145,1227722692, 1372188096}   
...
var = true
  elseif tonumber(user_id) == tonumber(1603288696) then
var = true
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'تيتو الهقر',url="t.me/e2_c11"}}, 
...
os.execute('wget https://raw.githubusercontent.com/Snipertito/evall/main/DRAGON.lua')
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/evalllllllll/33&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/evalllllllll/33&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝓽𝓲𝓽𝓸',url="t.me/e2_c11"},{text = '𖣘 Tweety Ofline 𖣘', url="t.me/Tweety_Ofline"}},
{{text = '𖣘 𝚃𝙾 𝙰𝚂𝙺 𖣘',url="t.me/e2_c12bot"}}, 
{{text = '𖣘 SＯＵＲСＥ EＶＡＬ 𖣘 ', url="t.me/SourceEval"}},
{{text = 'اضف البوت الي مجموعتك 🔺︙' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}}, 
}
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'ＧＬＩＴＳＨ❤️',url="t.me/Xccpp"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Xccpp&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'بتٲع ٲلخمره يبني❤️',url="t.me/Tweety_Ofline"}},
}
local msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'عموره الجمد❤️',url="t.me/BOT3mora"}},
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'تربو'  then
local Text = [[
تربو صٲحب ٲلتليجرٲم يبني لؤ عٲيز تتؤٲصل معٲه
اتبع الزر إلى تحت ↓
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'تربؤ ٲلقٲمد❤️',url="t.me/UU_T_U_R_B_O"}},
}
local msg_id = msg.id_/2097152/0.5
...
{{text = 'عموره الهقر',url="t.me/BOT3mora"}},
{{text = 'جليتش ييكسمك',url="t.me/Xccpp"}},
{{text = '𖣘 SＯＵＲСＥ EＶＡＬ 𖣘', url="t.me/SourceEval"}},
}
local msg_id = msg.id_/2097152/0.5
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/sorse_eval/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text == "احاديث" or text == 'حديث' and not  database:get(bot_id.."sing:for:me"..msg.chat_id_) then 
ght = math.random(1,62); 
local Text ='تم اختيار هذا الحديث لك' 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'ＧＬＩＴＳＨ',url="t.me/Xccpp"}},
{{text = '𖣘 SＯＵＲСＥ EＶＡＬ 𖣘',url="t.me/SourceEval"}},
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/T_e_m_o_1/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == "غنيلي فيديو" then  
ght = math.random(1,33);  
local Text ='ٲحلي ٲغنيه علي عنيك'  
keyboard = {}   
keyboard.inline_keyboard = {  
{{text = '  ❨ＧＬＩＴＳＨ❩ ', url="t.me/Xccpp"}},
...
{{text = '⦅ 𝒔𝒐𝒖𝒓??𝒆 EＶＡＬ ⦆', url="t.me/SourceEval"}},
}  
local msg_id = msg.id_/2097152/0.5  
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Snipertito/evall/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/Snipertito/evall/main/File_Bot/"..file)
if res == 200 then
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𖣘 SＯＵＲСＥ EＶＡＬ𖣘', url="t.me/SourceEval"}},
}
local msg_id = msg.id_/2097152/0.5
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت مطوري نور عنيا🥺🤍](t.me/SourceEval)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت مطوري الثاني حته مني 😍💚](t.me/SourceEval)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت المطور بس الصغنن 🌝💘](t.me/SourceEval)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[نت المالك هن يعني حاجه فوق فوق راسي 😂♥](t.me/SourceEval)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه??🤦‍♂️](t.me/SourceEval)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/SourceEval)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/SourceEval)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/SourceEval)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[ انت مميز ابن ناس 😊 ](t.me/SourceEval)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[ عضو قميل 🌝💘 ](t.me/SourceEval)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
send(msg.chat_id_,msg.id_, ' منا شغال اهو يبنملرا 😼 ') 
return false
end
...
send(msg.chat_id_,msg.id_, '[متخدوني بيف معاكو يشبح..🥺💔](t.me/SourceEval)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عيط في حضني تع..😥](t.me/SourceEval)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عـيـب يبنلمرا..🙄💔](t.me/SourceEval)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هتيجي يات ..😹👻](t.me/SourceEval)')
return false
end
end
end
...
if text == "ولد" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"دا عيل بيضااان","ولا بطيقه اصلا","اقل من اني افكر فيه","كسمو مش حوار"," ظريط سيببك منو"," يعم دا حكاك هتعمل عقلك بي","فكك من كسمو يعم","كسمو لاجل مشحوار","في اي يبنلوسخه مزعل عمك لي؟!!"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
...
if text == "افشخو" or text == "نيكو" or text == "نيكها" or text == "افشخها" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"فكك من كسمو يعم","كسمو لاجل مشحوار","في اي يبنلوسخه مزعل عمك لي؟!! "}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
