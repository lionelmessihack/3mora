...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/SRC-ELKIMA/Files_ELKIMA/main/File_Bot/commands.lua") 
...
os.execute('wget https://raw.githubusercontent.com/SRC-ELKIMA/ELKIMA/main/ELKIMA.lua')
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/SRC-ELKIMA/Files_ELKIMA/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/SRC-ELKIMA/Files_ELKIMA/main/File_Bot/"..file)
if res == 200 then
